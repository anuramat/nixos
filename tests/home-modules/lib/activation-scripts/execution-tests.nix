...
{ testLib }:
let
  inherit (testLib) mkExecutionTest checkExecution mkRealActivationTest mkPureActivationTest homeLib;
in
{
      ...
      let
        ...
        expectedData = {
          ...
          nested = {
            ...
            deep = {
              level = 1;             # Unchanged
              existing_array = [1 2]; # Preserved
            };
          };
          array_base = ["a" "b"];    # Preserved
