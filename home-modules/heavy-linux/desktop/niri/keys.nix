...
#     Mod+D hotkey-overlay-title="Run an Application: fuzzel" { spawn "/nix/store/v0xnw3b26jwdwv5qz8vc8z8yk34xfc08-mkmenu"; }
#     Super+Ctrl+Q hotkey-overlay-title="Lock the Screen: swaylock" { spawn "swaylock"; }
#
